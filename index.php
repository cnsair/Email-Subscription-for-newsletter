...
<head>
	<title>Eagleslifedomain - connecting you</title>
	<meta charset="UTF-8">
		...
		<div class="size1 p-l-15 p-r-15 p-t-30 p-b-50">
			<div class="flex-w flex-sb-m p-l-75 p-r-60 p-b-165 respon1">
				<div class="wrappic1 m-r-30 m-t-10 m-b-10">
					<a href="#"><img height="100px" src="images/icons/eld-logo-white2.png" alt="LOGO"></a>
				</div>

				<div class="flex-w m-t-10 m-b-10">
					<a target="_blank" href="#https://www.facebook.com/eagleslifedomainofficial" class="size4 flex-c-m how-social trans-04 m-r-5 m-b-3 m-t-3">
						<i class="fa fa-facebook"></i>
					</a>

					<a target="_blank" href="#https://www.instagram.com/eagleslifedomainofficial" class="size4 flex-c-m how-social trans-04 m-r-5 m-b-3 m-t-3">
						<i class="fa fa-instagram"></i>
					</a>

					<a target="_blank" href="#https://api.whatsapp.com/send?phone=2348092568076" class="size4 flex-c-m how-social trans-04 m-r-5 m-b-3 m-t-3">
			...
			<div class="wsize1 m-lr-auto">
				<p class="txt-center l1-txt1 p-b-60">
					<span style="font-family: sans-serif, Verdana, Geneva, Tahoma; font-weight: bold; word-break: break-all;">EAGLESLIFEDOMAIN.COM</span> is <span class="l1-txt2">Coming Soon</span>, follow us for update now!
				</p>
				...
				<form action="" method="POST" class="w-full flex-w flex-c-m validate-form">
					...
					<!-- <input style="color: rgb(1, 9, 53);" type="submit" class="btn btn-success flex-c-m size3 m1-txt2 how-btn1 trans-04 m-b-20" value="Subscribe"> -->
				</form>
